"""
Routes School Street 170, 216, 262 (the segment that the register
assigns to Winter Hill, not Argenziano: "SCHOOL STREET 121-END WINTER
HILL") to Winter Hill School.

Run: python3 fetch_school_street_winterhill.py
Outputs: school_street_winterhill_walks.json -- upload to Claude
"""
...
with open("school_street_to_winterhill.json") as f:
    samples = json.load(f)
...
with open("school_street_winterhill_walks.json", "w") as f:
    json.dump(samples, f, indent=2)
print("\nSaved. Upload school_street_winterhill_walks.json to Claude")
