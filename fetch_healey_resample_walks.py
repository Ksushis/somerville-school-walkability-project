"""
Walking distances for the 224 high-resolution Healey zone sample points.

Run: python3 fetch_healey_resample_walks.py
Outputs: healey_resample_walks.json -- upload to Claude
"""
...
samples = []
with open("healey_resample_clean.csv") as f:
...
results = []
total = len(samples)
print("Routing " + str(total) + " points to Healey...\n")
