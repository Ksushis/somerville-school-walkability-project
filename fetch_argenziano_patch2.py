"""
Patches Highland Avenue and Medford Street with edge coordinates.
Place in same directory as argenziano_walk.json and run:
  python3 fetch_argenziano_patch2.py
"""
...
patches = [
    {"street": "Highland Avenue 6-146", "lat": 42.3981,  "lon": -71.11146},
    {"street": "Medford Street 8-252",  "lat": 42.37365, "lon": -71.08749},
]
