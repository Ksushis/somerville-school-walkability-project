"""
Walking distances for the 22 sampled points (Beacon St, Hudson St,
Somerville Ave, Lowell St) to Kennedy School and Winter Hill.
Run: python3 fetch_kennedy_west_walks.py
Outputs: kennedy_west_streets_walks.json — upload to Claude
"""
...
samples = []
with open("kennedy_west_streets_to_geocode_geocodio_dc4f6f813ca69b8e16d10e7f1286472804bf0328.csv") as f:
...
results = []
print("Routing " + str(len(samples)) + " points to Kennedy and Winter Hill...\n")
for i, s in enumerate(samples):
    try:
        ...
        results.append({**s, "kennedy_walk_mi": None, "wh_walk_mi": None})
    time.sleep(2)

with open("kennedy_west_streets_walks.json", "w") as f:
    json.dump(results, f, indent=2)

print("\nDone. Upload kennedy_west_streets_walks.json to Claude")
