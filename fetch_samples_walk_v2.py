"""
Recalculates walking distances from all 268 Brown K-5 sample addresses
to the corrected Winter Hill site coordinate (115 Sycamore St, geocod.io rooftop).

Place in the same directory as your geocodio CSV file.
Run: python3 fetch_samples_walk_v2.py
Outputs: samples_walk_v2.json — upload to Claude
"""
...
WH = [-71.098797, 42.391667]  # 115 Sycamore St — geocod.io rooftop
...
results = []
print(f"Routing {len(samples)} addresses to corrected WH coordinate...\n")
...
with open("samples_walk_v2.json", "w") as f:
...
print("\nUpload samples_walk_v2.json to Claude")
